#!/usr/bin/env python3
# -*- coding: utf-8 -*-
__author__ = "Cédric Bouysset, Luca Monari"
# created by Cédric Bouysset, modified by Luca Monari and Katia Galentino
__credits__ = ["Cédric Bouysset", "Luca Monari", "Katia Galentino", "Marco Cecchini"]
__version__ = "1.0"
__email__ = "cbouysset@unice.fr"
...
def get_shape(inputfile, shape, padding):
	# Read file
	...
	if shape == 'box':
		return bounding_box(XYZ, padding)
		
	elif shape == 'sphere':
		return average_bs(XYZ, padding)
